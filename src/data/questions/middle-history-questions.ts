...
export const middleHistoryQuestions: Question[] = [
  ...
  // ==================== 材料解析题 (m-his-005) ====================
  {
    id: 'q-mi-005-1', type: 'choice', difficulty: 'basic',
    stem: '下列关于"材料解析题"的说法，正确的是（    ）。',
    options: ['A. 它是${subject}学习的基础', 'B. 它不重要', 'C. 它只在高年级学习', 'D. 它不需要练习'],
    answer: 'A',
    explanation: '材料解析题是历史学习的基础内容，需要认真掌握。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-2', type: 'fill-blank', difficulty: 'basic',
    stem: '学习"材料解析题"要______。',
    answer: '认真听讲、勤加练习',
    explanation: '学习材料解析题需要认真听讲、勤加练习。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-3', type: 'true-false', difficulty: 'basic',
    stem: '"材料解析题"是初中历史学习的重要内容。',
    answer: 'true',
    explanation: '材料解析题是初中历史学习的重要内容。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-4', type: 'choice', difficulty: 'basic',
    stem: '下列例子中，与"材料解析题"相关的是（    ）。',
    options: ['A. 例一', 'B. 例二', 'C. 例三', 'D. 例四'],
    answer: 'A',
    explanation: 'A选项与材料解析题相关。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-5', type: 'fill-blank', difficulty: 'basic',
    stem: '"材料解析题"的关键是______。',
    answer: '理解和运用',
    explanation: '学习材料解析题的关键是理解和运用。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-6', type: 'true-false', difficulty: 'basic',
    stem: '学习"材料解析题"只需要死记硬背。',
    answer: 'false',
    explanation: '学习材料解析题需要理解和运用，不能只靠死记硬背。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-7', type: 'choice', difficulty: 'basic',
    stem: '关于"材料解析题"的学习方法，下列说法正确的是（    ）。',
    options: ['A. 多读多练', 'B. 不练习', 'C. 只听课', 'D. 不复习'],
    answer: 'A',
    explanation: '学习材料解析题要多读多练。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-8', type: 'choice', difficulty: 'intermediate',
    stem: '运用"材料解析题"知识，下列解释最准确的是（    ）。',
    options: ['A. 例一', 'B. 例二', 'C. 例三', 'D. 例四'],
    answer: 'B',
    explanation: 'B选项运用了材料解析题的知识，解释准确。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-9', type: 'fill-blank', difficulty: 'intermediate',
    stem: '请写出一个体现"材料解析题"的例子：______。',
    answer: '开放性答案',
    explanation: '请运用材料解析题的知识写一个例子。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-10', type: 'true-false', difficulty: 'intermediate',
    stem: '"材料解析题"只在考试中用，与日常生活无关。',
    answer: 'false',
    explanation: '材料解析题与日常生活密切相关。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-11', type: 'choice', difficulty: 'intermediate',
    stem: '下列关于"材料解析题"的理解，正确的是（    ）。',
    options: ['A. 需要理解运用', 'B. 不需要理解', 'C. 只在高年级用', 'D. 不重要'],
    answer: 'A',
    explanation: '材料解析题需要理解运用。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-12', type: 'fill-blank', difficulty: 'intermediate',
    stem: '"材料解析题"与历史学习的关系是______。',
    answer: '密切相关',
    explanation: '材料解析题与历史学习密切相关。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-13', type: 'true-false', difficulty: 'intermediate',
    stem: '学习"材料解析题"需要联系生活实际。',
    answer: 'true',
    explanation: '联系生活实际有助于理解材料解析题。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-14', type: 'choice', difficulty: 'intermediate',
    stem: '下列现象中，"材料解析题"解释正确的是（    ）。',
    options: ['A. 例一', 'B. 例二', 'C. 例三', 'D. 例四'],
    answer: 'A',
    explanation: 'A选项的材料解析题解释正确。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-15', type: 'choice', difficulty: 'advanced',
    stem: '阅读下列材料，分析其中"材料解析题"的原理，正确的是（    ）。',
    options: ['A. 原理一', 'B. 原理二', 'C. 原理三', 'D. 原理四'],
    answer: 'C',
    explanation: 'C选项正确分析了材料解析题的原理。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-16', type: 'fill-blank', difficulty: 'advanced',
    stem: '请运用"材料解析题"分析下面的问题：______。',
    answer: '开放性答案',
    explanation: '请运用材料解析题知识分析问题。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-17', type: 'true-false', difficulty: 'advanced',
    stem: '"材料解析题"在不同情境中的应用可能不同。',
    answer: 'true',
    explanation: '材料解析题在不同情境中的应用可能不同。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-18', type: 'choice', difficulty: 'advanced',
    stem: '下列关于"材料解析题"的理解，最深刻的是（    ）。',
    options: ['A. 表面理解', 'B. 浅层理解', 'C. 深层理解', 'D. 错误理解'],
    answer: 'C',
    explanation: '深层理解材料解析题的本质。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-19', type: 'fill-blank', difficulty: 'advanced',
    stem: '请用一段话描述"材料解析题"的特点：______。',
    answer: '开放性答案',
    explanation: '请描述材料解析题的特点。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-20', type: 'true-false', difficulty: 'advanced',
    stem: '掌握"材料解析题"需要长期积累。',
    answer: 'true',
    explanation: '材料解析题的学习需要长期积累。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-21', type: 'choice', difficulty: 'advanced',
    stem: '下列关于"材料解析题"的应用，最恰当的是（    ）。',
    options: ['A. 应用一', 'B. 应用二', 'C. 应用三', 'D. 应用四'],
    answer: 'B',
    explanation: 'B选项的材料解析题应用最恰当。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
  {
    id: 'q-mi-005-22', type: 'fill-blank', difficulty: 'advanced',
    stem: '请设计一个验证"材料解析题"的实验或活动：______。',
    answer: '开放性答案',
    explanation: '请设计实验或活动验证材料解析题。',
    tags: ['材料解析题'],
    knowledgePointIds: ['m-his-005'], subject: '历史', grade: 'middle',
  },
