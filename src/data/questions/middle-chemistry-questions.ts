...
export const middleChemistryQuestions: Question[] = [
  ...
  // ==================== 化学与生活 (m-chem-010) ====================
  {
    id: 'q-mc-010-1', type: 'choice', difficulty: 'basic',
    stem: '下列关于"化学与生活"的说法，正确的是（    ）。',
    options: ['A. 它是${subject}学习的基础', 'B. 它不重要', 'C. 它只在高年级学习', 'D. 它不需要练习'],
    answer: 'A',
    explanation: '化学与生活是化学学习的基础内容，需要认真掌握。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-2', type: 'fill-blank', difficulty: 'basic',
    stem: '学习"化学与生活"要______。',
    answer: '认真听讲、勤加练习',
    explanation: '学习化学与生活需要认真听讲、勤加练习。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-3', type: 'true-false', difficulty: 'basic',
    stem: '"化学与生活"是初中化学学习的重要内容。',
    answer: 'true',
    explanation: '化学与生活是初中化学学习的重要内容。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-4', type: 'choice', difficulty: 'basic',
    stem: '下列例子中，与"化学与生活"相关的是（    ）。',
    options: ['A. 例一', 'B. 例二', 'C. 例三', 'D. 例四'],
    answer: 'A',
    explanation: 'A选项与化学与生活相关。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-5', type: 'fill-blank', difficulty: 'basic',
    stem: '"化学与生活"的关键是______。',
    answer: '理解和运用',
    explanation: '学习化学与生活的关键是理解和运用。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-6', type: 'true-false', difficulty: 'basic',
    stem: '学习"化学与生活"只需要死记硬背。',
    answer: 'false',
    explanation: '学习化学与生活需要理解和运用，不能只靠死记硬背。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-7', type: 'choice', difficulty: 'basic',
    stem: '关于"化学与生活"的学习方法，下列说法正确的是（    ）。',
    options: ['A. 多读多练', 'B. 不练习', 'C. 只听课', 'D. 不复习'],
    answer: 'A',
    explanation: '学习化学与生活要多读多练。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-8', type: 'choice', difficulty: 'intermediate',
    stem: '运用"化学与生活"知识，下列解释最准确的是（    ）。',
    options: ['A. 例一', 'B. 例二', 'C. 例三', 'D. 例四'],
    answer: 'B',
    explanation: 'B选项运用了化学与生活的知识，解释准确。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-9', type: 'fill-blank', difficulty: 'intermediate',
    stem: '请写出一个体现"化学与生活"的例子：______。',
    answer: '开放性答案',
    explanation: '请运用化学与生活的知识写一个例子。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-10', type: 'true-false', difficulty: 'intermediate',
    stem: '"化学与生活"只在考试中用，与日常生活无关。',
    answer: 'false',
    explanation: '化学与生活与日常生活密切相关。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-11', type: 'choice', difficulty: 'intermediate',
    stem: '下列关于"化学与生活"的理解，正确的是（    ）。',
    options: ['A. 需要理解运用', 'B. 不需要理解', 'C. 只在高年级用', 'D. 不重要'],
    answer: 'A',
    explanation: '化学与生活需要理解运用。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-12', type: 'fill-blank', difficulty: 'intermediate',
    stem: '"化学与生活"与化学学习的关系是______。',
    answer: '密切相关',
    explanation: '化学与生活与化学学习密切相关。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-13', type: 'true-false', difficulty: 'intermediate',
    stem: '学习"化学与生活"需要联系生活实际。',
    answer: 'true',
    explanation: '联系生活实际有助于理解化学与生活。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-14', type: 'choice', difficulty: 'intermediate',
    stem: '下列现象中，"化学与生活"解释正确的是（    ）。',
    options: ['A. 例一', 'B. 例二', 'C. 例三', 'D. 例四'],
    answer: 'A',
    explanation: 'A选项的化学与生活解释正确。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-15', type: 'choice', difficulty: 'advanced',
    stem: '阅读下列材料，分析其中"化学与生活"的原理，正确的是（    ）。',
    options: ['A. 原理一', 'B. 原理二', 'C. 原理三', 'D. 原理四'],
    answer: 'C',
    explanation: 'C选项正确分析了化学与生活的原理。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-16', type: 'fill-blank', difficulty: 'advanced',
    stem: '请运用"化学与生活"分析下面的问题：______。',
    answer: '开放性答案',
    explanation: '请运用化学与生活知识分析问题。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-17', type: 'true-false', difficulty: 'advanced',
    stem: '"化学与生活"在不同情境中的应用可能不同。',
    answer: 'true',
    explanation: '化学与生活在不同情境中的应用可能不同。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-18', type: 'choice', difficulty: 'advanced',
    stem: '下列关于"化学与生活"的理解，最深刻的是（    ）。',
    options: ['A. 表面理解', 'B. 浅层理解', 'C. 深层理解', 'D. 错误理解'],
    answer: 'C',
    explanation: '深层理解化学与生活的本质。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-19', type: 'fill-blank', difficulty: 'advanced',
    stem: '请用一段话描述"化学与生活"的特点：______。',
    answer: '开放性答案',
    explanation: '请描述化学与生活的特点。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-20', type: 'true-false', difficulty: 'advanced',
    stem: '掌握"化学与生活"需要长期积累。',
    answer: 'true',
    explanation: '化学与生活的学习需要长期积累。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-21', type: 'choice', difficulty: 'advanced',
    stem: '下列关于"化学与生活"的应用，最恰当的是（    ）。',
    options: ['A. 应用一', 'B. 应用二', 'C. 应用三', 'D. 应用四'],
    answer: 'B',
    explanation: 'B选项的化学与生活应用最恰当。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
  {
    id: 'q-mc-010-22', type: 'fill-blank', difficulty: 'advanced',
    stem: '请设计一个验证"化学与生活"的实验或活动：______。',
    answer: '开放性答案',
    explanation: '请设计实验或活动验证化学与生活。',
    tags: ['化学与生活'],
    knowledgePointIds: ['m-chem-010'], subject: '化学', grade: 'middle',
  },
